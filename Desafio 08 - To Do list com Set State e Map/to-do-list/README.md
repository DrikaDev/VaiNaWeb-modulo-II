# To Do List <img src="https://i.ibb.co/QpLTKSz/badge-M2-T2.png" alt="Badge Vai Na Web T2.1" width="100" align="right">

Exercício para treinar os estudos de React pelo curso do Vai Na Web.
Objetivo: criar um To Do List com as seguintes características:
